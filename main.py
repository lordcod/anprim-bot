...
class IdeaModal(nextcord.ui.Modal):
    ...
    async def callback(self, interaction: nextcord.Interaction) -> None:
        name = interaction.user.global_name if interaction.user.global_name and interaction.user.name == interaction.user.display_name else interaction.user.display_name
